...
cluster, a geo-distributed backup fleet, and the platform that runs on top of them. I
write down what happens, including the parts that go wrong.
...
addresses. There is no public endpoint anywhere in the fleet.
